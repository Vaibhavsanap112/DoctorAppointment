      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            {/* ......doctor about........ */}
            <div>
              <p className="flex itms-center gap-1 text-sm font-medium text-gray-900 mt-3">
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <button className="bg-[#5f6fff] text-white text-sm font-light px-14 py-3 my-6 rounded-full ">Book an appointment</button>
        </div>
        {/* .......Listing Related Doctors */}

        <RelatedDotors docId={docId} speciality={docInfo.speciality}></RelatedDotors>
      </div>
    )
  )
}
